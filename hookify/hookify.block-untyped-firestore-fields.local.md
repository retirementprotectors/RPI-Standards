...
conditions:
  ...
  - field: file_path
    ...
    # REBASE NOTE (megazord, 2026-07-26): #55 and this PR documented the SAME condition from two
    # angles — shinob1's explains WHY the scoping exists, mine documents the coverage decision.
    # Kept BOTH. Neither author's reasoning was dropped to resolve the conflict.
