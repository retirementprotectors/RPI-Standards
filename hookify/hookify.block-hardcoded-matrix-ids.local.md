...
// CORRECT
const MATRIX_ID = RAPID_CORE.getMATRIX_ID('PRODASH');

// Or via Script Properties fallback
const MATRIX_ID = PropertiesService.getScriptProperties().getProperty('PRODASH_MATRIX_ID');
```
