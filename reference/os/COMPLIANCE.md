...
| **PHI exposure** (PHI reaches a non-BAA surface: Slack, logs, public repo) | Pull the surface (e.g. repo → private; delete the message) | Confirm no further propagation (caches/edges can lag — note it) | **JDM IMMEDIATELY** — suspected PHI breach is the highest-severity class |
