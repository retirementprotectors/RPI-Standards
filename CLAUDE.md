...
The **hookify plugin** (`~/.claude/plugins/marketplaces/claude-plugins-official/plugins/hookify/`) — 70 rules, 4 hook events, enforces standards in real-time. Full reference: `_RPI_STANDARDS/reference/os/IMMUNE_SYSTEM.md`

**70 rules** (66 top-level + 4 scope-bound `.local.md` files in `_RPI_STANDARDS/hookify/`):
