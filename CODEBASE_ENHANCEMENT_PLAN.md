...
- **Target:** `RAPID_CORE/CORE_Api.gs` → `callGasAPI_()`
...
- **Target:** `RAPID_CORE/CORE_Database.gs` → `readMatrixSheet_()`
...
|-------|------|-------|--------|-----------|
| 1.1 | Extract callGasAPI_() | - | Not Started | |
| 1.2 | Extract readMatrixSheet_() | - | Not Started | |
| 1.3 | Add PHI masking utilities | - | Not Started | |
